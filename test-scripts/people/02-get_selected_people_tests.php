...
function basalt_test_define_0026() {
    basalt_run_single_direct_test(26, 'Access Users and Logins By Numerical ID (JSON)', 'GET tests for people and logins; with and without various logins.', 'people_tests');
}
...
function basalt_test_define_0027() {
    basalt_run_single_direct_test(27, 'Access Users and Logins By Numerical ID (JSON)', 'GET tests for people and logins; with and without various logins.', 'people_tests');
}
