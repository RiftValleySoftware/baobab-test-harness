...
function basalt_test_0022($in_login = NULL, $in_hashed_password = NULL, $in_password = NULL) {
    ...
    $data = NULL;
    $expected_result_code = 200;
    $expected_result = '{"people":{"people":{"my_info":{"id":1731,"name":"God Admin","lang":"en","coords":"38.871900,-77.056300","read_token":1,"write_token":2,"last_access":"1970-01-02 00:00:00","writeable":true,"latitude":38.8719,"longitude":-77.0563,"middle_name":"TAG-2-TEST-PEOPLE","is_manager":true,"is_main_admin":true,"current_login":true,"associated_login":{"id":2,"name":"God Admin Login","lang":"en","login_id":"admin","read_token":2,"write_token":2,"last_access":"1970-01-02 00:00:00","writeable":true,"current_login":true,"user_object_id":1731,"is_manager":true,"is_main_admin":true,"security_tokens":[2],"current_api_key":true,"api_key":"'.$api_key.'","api_key_age_in_seconds":1}}}}}';
    $result_code = '';
    ...
    $data = NULL;
    $expected_result_code = 200;
    $expected_result = '{"people":{"logins":{"my_info":{"id":2,"name":"God Admin Login","lang":"en","login_id":"admin","read_token":2,"write_token":2,"last_access":"1970-01-02 00:00:00","writeable":true,"current_login":true,"user_object_id":1731,"is_manager":true,"is_main_admin":true,"security_tokens":[2],"current_api_key":true,"api_key":"'.$api_key.'","api_key_age_in_seconds":1}}}}';
    $result_code = '';
...
function basalt_test_0023($in_login = NULL, $in_hashed_password = NULL, $in_password = NULL) {
    ...
    $data = NULL;
    $expected_result_code = 200;
    $expected_result = get_xml_header('people').'<people><my_info><id>1731</id><name>God Admin</name><lang>en</lang><coords>38.871900,-77.056300</coords><read_token>1</read_token><write_token>2</write_token><last_access>1970-01-02 00:00:00</last_access><writeable>1</writeable><latitude>38.8719</latitude><longitude>-77.0563</longitude><middle_name>TAG-2-TEST-PEOPLE</middle_name><is_manager>1</is_manager><is_main_admin>1</is_main_admin><current_login>1</current_login><associated_login><id>2</id><name>God Admin Login</name><lang>en</lang><login_id>admin</login_id><read_token>2</read_token><write_token>2</write_token><last_access>1970-01-02 00:00:00</last_access><writeable>1</writeable><current_login>1</current_login><user_object_id>1731</user_object_id><is_manager>1</is_manager><is_main_admin>1</is_main_admin><security_tokens><value sequence_index="0">2</value></security_tokens><current_api_key>1</current_api_key><api_key>'.$api_key.'</api_key><api_key_age_in_seconds>1</api_key_age_in_seconds></associated_login></my_info></people></people>';
    $result_code = '';
    ...
    $data = NULL;
    $expected_result_code = 200;
    $expected_result = get_xml_header('people').'<logins><my_info><id>2</id><name>God Admin Login</name><lang>en</lang><login_id>admin</login_id><read_token>2</read_token><write_token>2</write_token><last_access>1970-01-02 00:00:00</last_access><writeable>1</writeable><current_login>1</current_login><user_object_id>1731</user_object_id><is_manager>1</is_manager><is_main_admin>1</is_main_admin><security_tokens><value sequence_index="0">2</value></security_tokens><current_api_key>1</current_api_key><api_key>'.$api_key.'</api_key><api_key_age_in_seconds>1</api_key_age_in_seconds></my_info></logins></people>';
    $result_code = '';
